  ...
  head: () => ({
    meta: [
      ...
      { title: "YZ Construction, LLC — Remodeling & Construction in the DMV" },
      {
        name: "description",
        content:
          "Licensed, insured, family-owned construction and remodeling in Silver Spring, MD. Kitchens, bathrooms, whole-home, restaurants, and commercial builds across MD, DC, and VA.",
      },
